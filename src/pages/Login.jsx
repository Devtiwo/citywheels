...
const Login = () => {
  ...
  return (
    <section className="p-8 h-full">
      {loading && <Preloader />}
      <div className="grid grid-cols-1 lg:grid-cols-2 container mx-auto shadow-2xl rounded-3xl my-12">
        <div className="bg-gradient-to-r from-white to-lime-50 p-8">
          <div className="m-5">
            <img src="/images/citywheellogo.png" alt="citywheel logo" />
          </div>
          <h1 className="text-3xl font-medium mt-8 ml-5 mb-5">Welcome Back</h1>
          <svg
          ...
          >
            ...
            <path
              ...
              fill="#ccc"
            />
            <circle cx="524.99994" cy="335.5" r="16" fill="#98be0f" />
            <polygon
        ...
        <div className="bg-gradient-to-r from-lime-50 to-white p-8">
          {message && (<div className="text-center font-medium"><small style={{color: status === "failed" && "red"}}>{message}</small></div>)}
          <h2 className="text-center text-2xl font-medium mt-16">
            Login your account
          </h2>
          <form
            className="p-5 my-10 w-4/5 mx-auto"
            autoComplete="off"
            method="POST"
          ...
          >
            <div className="mb-6">
              ...
              <div className="flex p-2 my-3 rounded-lg border-2 border-lime-500">
                <div className="p-1 mr-1">
                  <MdOutlineEmail className="text-2xl text-lime-500" />
                </div>
                <div className="w-full">
                  <input
                    type="email"
                    className="p-1 w-full bg-transparent outline-0"
                    placeholder="Email"
                    name="email"
                    id="email"
            ...
            <div>
              ...
              <div className="flex p-2 my-3 rounded-lg border-2 border-lime-500">
                <div className="p-1 mr-1">
                  <MdLockOutline className="text-2xl text-lime-500" />
                </div>
                <div className="w-full">
                  <input
                    type="password"
            ...
            <div className="lg:flex justify-between">
              <div className="my-8 mx-auto lg:mx-0 w-28">
                <button
                  type="submit"
                  className="bg-lime-600 transition ease-in duration-200 text-white hover:text-black hover:bg-lime-500 font-semibold py-3 px-8 rounded-lg"
                >
                  Login
                </button>
              </div>
              <div className="w-38 my-2 lg:my-10">
                <small className="font-medium hover:text-lime-500">
